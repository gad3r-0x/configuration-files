...
Ubuntu 18.04 (bionc) sources repository
...
Ubuntu Testing and EOL releases.

Ubuntu 17.04 (zesty) repositories
...
Ubuntu 17.10 (artful) repositories (EOL)
...
Ubuntu 19.04 (disco) repositories
...
```
Ubuntu 19.10 (eoan) repositories
...
deb http://old-releases.ubuntu.com/ubuntu/ eoan-proposed main restricted universe multiverse 
deb http://old-releases.ubuntu.com/ubuntu/ eoan-backports main restricted universe multiverse

deb-src http://old-releases.ubuntu.com/ubuntu/ eoan-security main restricted universe multiverse 
deb-src http://old-releases.ubuntu.com/ubuntu/ eoan-updates main restricted universe multiverse 
deb-src http://old-releases.ubuntu.com/ubuntu/ eoan-proposed main restricted universe multiverse 
...
Ubuntu 20.10 (groovy) repositories

```
deb http://us.archive.ubuntu.com/ubuntu/ groovy main restricted universe multiverse 
deb http://us.archive.ubuntu.com/ubuntu/ groovy-security main restricted universe multiverse 
deb http://us.archive.ubuntu.com/ubuntu/ groovy-updates main restricted universe multiverse 
deb http://us.archive.ubuntu.com/ubuntu/ groovy-proposed main restricted universe multiverse 
...
deb-src http://us.archive.ubuntu.com/ubuntu/ groovy main restricted universe multiverse 
deb-src http://us.archive.ubuntu.com/ubuntu/ groovy-security main restricted universe multiverse 
deb-src http://us.archive.ubuntu.com/ubuntu/ groovy-updates main restricted universe multiverse 
deb-src http://us.archive.ubuntu.com/ubuntu/ groovy-proposed main restricted universe multiverse 
deb-src http://us.archive.ubuntu.com/ubuntu/ groovy-backports main restricted universe multiverse
